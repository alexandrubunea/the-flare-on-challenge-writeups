...
![Details from exiftool](image.png)

Good, but not enough. Running it through DIE as well:

![Details from DIE](image-1.png)
...
![Running the program](image-2.png)
...
![Hidden assembly code](image-4.png)
...
![Keep stepping into the program](image-7.png)
