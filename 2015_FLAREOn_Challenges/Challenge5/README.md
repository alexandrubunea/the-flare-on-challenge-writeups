...
![exiftool result on the program](image.png)

Then running DIE:

![die result on the program](image-1.png)
...
![strings result on the program](image-2.png)
...
![Main function in Ghidra](image-3.png)
...
![Custom encoder found](image-4.png)
...
![Trying to connect to a host](image-5.png)
...
![apply_flarebearstare function after modifying the signature](image-6.png)
...
![http requests inside WireShark](image-7.png)

The POST request bodies need to be extracted and concatenated in order:

![Data that needs concatenation](image-8.png)
...
![Using rapidtables.com to see the string in ASCII](image-9.png)
...
![Result of running the script](image-10.png)
