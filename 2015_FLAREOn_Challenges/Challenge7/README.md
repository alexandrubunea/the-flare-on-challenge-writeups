...
![Result of running exiftool](image.png)

DIE is run next to characterize the binary more precisely.

![Result of running die](image-1.png)
...
![Program launch to show the text](image-5.png)

A breakpoint is set at the comparison to observe `text2` in the debugger.

![Table of values at the breakpoint](image-6.png)
...
![Image of the IL code relevant to the function above](image-7.png)
...
![Secret password extracted](image-8.png)
