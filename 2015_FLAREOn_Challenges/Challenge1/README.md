...
![exiftool output of the extracted executable](image-2.png)

![DIE output of the extracted executable](image-3.png)
...
![Graph view of the program's control flow](image-4.png)
