...
![Value stored at the top of the stack](image-7.png)

Tracing it back: just before the XOR, `push eax` was executed with `AX = 0x1C7`:

![Disassembly code of push eax](image-8.png)
...
![Image of sub edi, 2](image-10.png)
