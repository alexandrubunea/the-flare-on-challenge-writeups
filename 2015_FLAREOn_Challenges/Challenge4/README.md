...
![exiftool on unpacked program](image-2.png)

![DIE on unpacked program](image-3.png)
...
![Correct main signature](image-4.png)
...
![Running the program to test](image-5.png)
...
![Patched code in Ghidra](image-6.png)

![Saving the patched program](image-7.png)

Running the patched binary with an argument still exits immediately, indicating there is more to understand.

![Program behaving the same after patching](image-8.png)
...
![Flag reveal after running the binary with the current hour](image-9.png)
...
![Running the packed file](image-10.png)
